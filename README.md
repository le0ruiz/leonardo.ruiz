...
| **CSS3** | Diseño con Variables CSS, Flexbox, CSS Grid y animaciones. |
| **JavaScript (ES6+)** | Interactividad, toggle de idioma, IntersectionObserver para animaciones. |
| **Font Awesome** | Iconografía vectorial. |
| **Google Fonts** | Tipografía "Inter" (diseño limpio y profesional). |
| **Vercel** | Despliegue continuo (CI/CD) y hosting. |
